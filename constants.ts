...
export const QUALITATIVE_DATA: QualitativeExample[] = [
  // --- ProcTHOR Examples ---
  {
    ...
    dataset: 'ProcTHOR',
    category: 'Existence',
    question: "Choose an object that is present on the bed: A. bottle B. teddy bear C. pen D. towel",
    think: "The task is to find an object on the bed. To do this, I need to exit the room by opening the door and then proceed to the bedroom. The door is slightly ajar, so I can see part of the adjacent room. The bedroom is located to the right of the current room, which means I should turn right.",
  ...
  },
  {
    ...
    dataset: 'ProcTHOR',
    category: 'Existence',
    question: "Choose an object that is present on the dresser: A. vase B. potato C. apple D. faucet",
  ...
  },
  {
    ...
    think: "The TV stand is located on the right side of the room, and it's necessary to move towards it to see the bottles on top. The required movement involves a significant right turn followed by a forward step to approach the stand.",
  ...
  },
  {
    ...
    think: "The TV stand is located to the upper left in the image. To see it, I need to turn my head to the left. After that, I should move forward until I can see the TV stand clearly.",
  ...
  },
  {
    ...
    dataset: 'ProcTHOR',
    category: 'State',
    question: "Choose a faucet's state on the sink. A: turned off. B: turned on.",
    think: "The faucet is on the left side of the sink, so I need to move towards it. The angle needed to get there is -57 degrees, which means I should turn left. After reaching the sink, I'll need to adjust my view slightly.",
  ...
  },
  {
    ...
    dataset: 'ProcTHOR',
    category: 'State',
    question: "Choose a box's state on the dining table. A: closed. B: opened.",
    think: "The table is on the left side of the image. To see the table, I need to turn to the left. Then, I can move forward to get closer to the table.",
  ...
  // --- HM3D Examples ---
  {
    ...
    think: "The table on the right side of the image is the dining table. The table is not fully visible... To see the table, I need to turn to the right and move forward.",
  ...
  },
  {
    ...
    think: "The dining table is located towards the right side of the room... To see the entire table and the chairs, I need to move towards the right.",
  ...
  },
  {
    ...
    think: "The plant is located on the far right side of the room, which is currently out of view. To see it, I need to turn right and move forward.",
