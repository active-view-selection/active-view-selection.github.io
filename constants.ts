...
export const BIBTEX = `@article{koo:2025ambulatoryvision,
      title={Toward Ambulatory Vision: Learning Visually-Grounded Active View Selection},
      author={Juil Koo and Daehyeon Choi and Sangwoo Youn and Phillip Y. Lee and Minhyuk Sung},
      journal={arXiv preprint arXiv:2512.13250},
      year={2025}
}`;
