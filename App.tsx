    ...
    <div className="min-h-screen bg-white text-slate-900 selection:bg-blue-100 selection:text-blue-900">
      ...
      <main className="container mx-auto px-4 pb-20 space-y-24">
        ...
        <div className="max-w-5xl mx-auto rounded-2xl overflow-hidden shadow-2xl border border-slate-200 bg-slate-100 aspect-video relative group cursor-pointer">
           <img 
            src="https://placehold.co/1280x720/e2e8f0/475569?text=Teaser+Video+%2F+Overview+Animation" 
            alt="Teaser" 
            className="w-full h-full object-cover"
          />
           <div className="absolute inset-0 flex items-center justify-center bg-black/10 group-hover:bg-black/20 transition-all">
              <div className="bg-white/90 backdrop-blur rounded-full px-6 py-3 font-semibold text-slate-900 shadow-lg transform group-hover:scale-105 transition-transform flex items-center gap-2">
