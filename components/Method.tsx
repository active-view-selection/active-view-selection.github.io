    ...
    <section className="py-12">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <Figure 
          ...
          caption={
            <span>
              <strong>Figure 2.</strong> Overview of training strategies. (Top) SFT trains the model to predict ground-truth actions. (Bottom) RL allows the model to explore and is rewarded when the final view enables a frozen VLM verifier to correctly answer the question.
            </span>
          } 
        />
      </div>
