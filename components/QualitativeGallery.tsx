          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="relative group rounded-xl overflow-hidden border border-slate-200 bg-slate-100 aspect-[4/3]">
                <img 
                  src={`https://placehold.co/600x450/f1f5f9/475569?text=${dataset}+Input+View:+${encodeURIComponent(currentItem.imageAlt)}`} 
              ...
              <div className="relative group rounded-xl overflow-hidden border border-slate-200 bg-slate-100 aspect-[4/3]">
                <img 
                  src={`https://placehold.co/600x450/f1f5f9/475569?text=${dataset}+Refined+View:+${encodeURIComponent(currentItem.imageAlt)}`} 
