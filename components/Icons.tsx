...
import { FileText, Github, Database, Video, ChevronRight, ChevronLeft, Brain, Footprints, Eye, Quote, Check } from 'lucide-react';
...
export const Icons = {
  ...
  BibTeX: () => <Quote size={18} className="mr-2" />,
  Check: () => <Check size={18} className="mr-2" />,
};