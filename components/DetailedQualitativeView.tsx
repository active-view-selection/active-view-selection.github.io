      ...
      <div className="container mx-auto max-w-6xl px-4 py-12 space-y-16">
        ...
        <section>
          ...
          <div className="bg-white p-4 rounded-2xl shadow-lg border border-slate-200">
             <Figure 
               src="https://placehold.co/1200x800/f8fafc/64748b?text=Figure+4:+Full+Width+Qualitative+Strip+(Comparison)" 
        ...
        <section>
          ...
          <div className="bg-white p-4 rounded-2xl shadow-lg border border-slate-200">
             <Figure 
               src="https://placehold.co/1200x600/f8fafc/64748b?text=Figure+6:+EQA+Pipeline+Integration+Diagram" 
               alt="EQA Integration"
               caption={
                 <span>
