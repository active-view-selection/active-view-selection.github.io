        ...
        <div className="flex flex-wrap gap-2 justify-center">
          {categories.map((cat) => (
            <button
              ...
              className={`px-3 py-1 rounded-full text-xs uppercase tracking-wide transition-all font-light ${activeCategory === cat
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div className="flex-1">
                <div className="text-lg text-slate-700 leading-tight whitespace-pre-line font-light">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="relative group rounded-xl overflow-hidden border border-slate-200 bg-slate-100 aspect-[4/3]">
                ...
                />
                <div className="absolute top-3 left-3 bg-black/60 backdrop-blur text-white text-xs px-2 py-1 rounded shadow-sm font-light">
                  Query View
                </div>
              </div>
              <div className="relative group rounded-xl overflow-hidden border border-slate-200 bg-slate-100 aspect-[4/3]">
                <img
                  ...
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                />
                <div className={`absolute top-3 left-3 bg-${datasetColor}-600/90 backdrop-blur text-white text-xs px-2 py-1 rounded shadow-sm font-light`}>
                  Target View
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-xl p-5 relative">
                ...
                <p className="text-slate-800 leading-relaxed italic text-sm md:text-base font-light">
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 text-sm text-slate-600 shadow-sm overflow-x-auto">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <span className="text-slate-500 text-xs block mb-1 font-light">Raw Output:</span>
                    <div className="bg-white p-3 rounded border border-slate-200 text-slate-700 break-all text-xs md:text-sm shadow-sm font-mono font-light">
                      {currentItem.action}
                    </div>
                  </div>
                  ...
                  {parsedActions && (
                    <div>
                      <span className="text-slate-500 text-xs block mb-1 font-light">Parsed Action:</span>
                      <div className="bg-white p-3 rounded border border-slate-200 shadow-sm">
                        <ul className="text-slate-700 space-y-1 text-xs md:text-sm font-light">
